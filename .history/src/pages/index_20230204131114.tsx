...
const Canva = () => {
  ...
  return (
    <div className="text-white grid grid-cols-3 gap-5">
      <div className="w-90 h-50 p-3  bg-gray-500  ">Not Started</div>
      <div className="w-90 h-50 p-3 bg-gray-500  ">Started</div>
      <div className="w-90 h-50 p-3 bg-gray-500  ">Done</div>
