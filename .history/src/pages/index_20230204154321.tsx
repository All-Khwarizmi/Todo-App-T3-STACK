...
const DeleteTodo = ({todo}: any) => {
 ...
 return (
   <div  className="flex text-1xl flex-row gap-6 md:grid-cols-3">
     ...
     <button
       ...
       className="container flex items-center bg-red-800 w-2/3 justify-center gap-12 px-4"
     >
       DELETE
     </button>
   </div>
        ...
        {todos?.data?.map((todo, index) => {
          if (todo.status === "TODO") {
            return (
              <div
                key={todo.id}
                className="text-1xl flex flex-rows-2 gap-6 md:grid-cols-3"
              >
